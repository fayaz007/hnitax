...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $user_id = $_SESSION['user_id']; // Assuming the user is logged in and their ID is in session
    ...
    // Set tax year to previous year if it's before April, otherwise use current year
