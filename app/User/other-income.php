<?php $current_page = "Other Sources of Income"; // Set the current page title
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    $stmt = $conn->prepare("SELECT * FROM employment_details WHERE user_id = ?");
                    ...
                    $query = "SELECT * FROM other_income WHERE user_id = ?";
                    $stmt = $conn->prepare($query);
                    $stmt->bind_param("i", $user_id);
                    $stmt->execute();
                    $result = $stmt->get_result();
