<?php
$current_page = "Personal Information"; // Set the current page title
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            if ($user_id) {
                ...
                $query = "SELECT * FROM spouse_information WHERE user_id = ?";
                if ($stmt = $conn->prepare($query)) {
            ...
            $sql = "SELECT * FROM contact_information WHERE user_id = ?";
            ...
            <?php $sql = "SELECT * FROM dependents WHERE user_id = ?";
            $stmt = $conn->prepare($sql);
